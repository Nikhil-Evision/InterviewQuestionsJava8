package com.evision.pagination.controller;

import com.evision.pagination.dto.APIResponse;
import com.evision.pagination.model.Product;
import com.evision.pagination.service.ProductService;
...
//    @Query(value = "SELECT e FROM Product_details e ORDER BY id")
//    public List<Product> findAllSortedBy();
